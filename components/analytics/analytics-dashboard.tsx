...
export function AnalyticsDashboard() {
  ...
  return (
    <div className="h-full space-y-6 bg-white p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-[#75a6ff] hover:bg-[#1e3fec]/10 transition-colors"
          >
